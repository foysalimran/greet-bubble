 ...
 *
 */
if ( ! class_exists( 'GREET_BUBBLE_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class GREET_BUBBLE_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
