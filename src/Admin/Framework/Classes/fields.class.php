 ...
 *
 */
if ( ! class_exists( 'GREET_BUBBLE_Fields' ) ) {
  abstract class GREET_BUBBLE_Fields extends GREET_BUBBLE_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="greet-bubble-before-text">'. $this->field['before'] .'</div>' : '';
    }
