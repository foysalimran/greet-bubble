...
if ( ! class_exists( 'GREET_BUBBLE_Abstract' ) ) {
  abstract class GREET_BUBBLE_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        GREET_BUBBLE::$css = apply_filters( "greet_bubble_{$this->unique}_output_css", GREET_BUBBLE::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'GREET_BUBBLE_Field_' . $field_type;
            ...
            if ( class_exists( $field_class ) ) {
              ...
              if ( method_exists( $field_class, 'output' ) || method_exists( $field_class, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  GREET_BUBBLE::$css .= $instance->output();
                }
