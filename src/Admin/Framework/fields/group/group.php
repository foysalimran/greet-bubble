  ...
  class GREET_BUBBLE_Field_group extends GREET_BUBBLE_Fields {
    ...
    public function render() {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="greet-bubble-cloneable-alert greet-bubble-cloneable-max">'. __( 'You cannot add more. To add unlimited items <a target="_blank" href="https://1.envato.market/gbdm79"><strong><i>Upgrade To Pro!</i></strong></a>', 'greet-bubble' ) .'</div>';
