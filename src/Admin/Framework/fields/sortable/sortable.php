...
if ( ! class_exists( 'GREET_BUBBLE_Field_sortable' ) ) {
  class GREET_BUBBLE_Field_sortable extends GREET_BUBBLE_Fields {
    ...
    public function render() {
      ...
      echo '<div class="greet-bubble-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="greet-bubble-sortable-item">';

          echo '<div class="greet-bubble-sortable-content">';
          ...
          GREET_BUBBLE::field( $field, $field_value, $unique_id, 'field/sortable' );
