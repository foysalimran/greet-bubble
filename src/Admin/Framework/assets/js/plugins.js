...
(function($) {
  ...
  function GREET_BUBBLEAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  GREET_BUBBLEAjaxChosen.prototype.init = function() {
  ...
  GREET_BUBBLEAjaxChosen.prototype.events = function() {
  ...
  GREET_BUBBLEAjaxChosen.prototype.search_field_focused = function() {
  ...
  GREET_BUBBLEAjaxChosen.prototype.search_welcome_message = function() {
  ...
  GREET_BUBBLEAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('greet-bubble-chosen', _this.options.data).done( function( response ) {
  ...
  GREET_BUBBLEAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.greet-bubble-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.GREET_BUBBLEChosenOrder($hidden_value, true);
  ...
  $.fn.GREET_BUBBLEAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new GREET_BUBBLEAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, GREET_BUBBLEAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  GREET_BUBBLEAbstractChosenOrder = (function() {

    function GREET_BUBBLEAbstractChosenOrder() {}

    GREET_BUBBLEAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    GREET_BUBBLEAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    GREET_BUBBLEAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    GREET_BUBBLEAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    GREET_BUBBLEAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    GREET_BUBBLEAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    GREET_BUBBLEAbstractChosenOrder.GREET_BUBBLEChosenOrder = function(select, order, force) {
    ...
    return GREET_BUBBLEAbstractChosenOrder;
  ...
  $.fn.extend({
    GREET_BUBBLEChosenOrder: function(order, force) {
      return _GREET_BUBBLEChosenOrder.GREET_BUBBLEChosenOrder(this, order, force);
    }
  });

  this._GREET_BUBBLEChosenOrder = (function(_super) {
    __extends(_GREET_BUBBLEChosenOrder, _super);

    function _GREET_BUBBLEChosenOrder() {
      _ref = _GREET_BUBBLEChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _GREET_BUBBLEChosenOrder.relAttributeName = 'data-option-array-index';

    _GREET_BUBBLEChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _GREET_BUBBLEChosenOrder.getDOMElement = function(element) {
    ...
    _GREET_BUBBLEChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _GREET_BUBBLEChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _GREET_BUBBLEChosenOrder;

  })(GREET_BUBBLEAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('greet-bubble-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('greet-bubble-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectGREET_BUBBLE = FormSerializer.serializeObject;
    $.fn.serializeJSONGREET_BUBBLE   = FormSerializer.serializeJSON;
  }
