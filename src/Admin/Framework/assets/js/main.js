...
;(function( $, window, document, undefined ) {
  ...
  GREET_BUBBLE.helper = {
    ...
    name_nested_replace: function( $selector, field_id ) {
      ...
      var checks = [];
      var regex  = new RegExp(GREET_BUBBLE.helper.preg_quote(field_id +'[\\d+]'), 'g');
  ...
  $.fn.greet_bubble_nav_options = function() {
    return this.each( function() {
      ...
      $window.on('hashchange greet-bubble.hashchange', function() {
        ...
        if ( $link.length ) {
          ...
          $link.closest('.greet-bubble-tab-item').addClass('greet-bubble-tab-expanded').siblings().removeClass('greet-bubble-tab-expanded');
  ...
  $.fn.greet_bubble_page_templates = function() {
    if ( this.length ) {
      ...
      $(document).on('change', '.editor-page-attributes__template select, #page_template, .edit-post-post-status + div select', function() {
        ...
        $('.greet-bubble-page-templates').removeClass('greet-bubble-metabox-show').addClass('greet-bubble-metabox-hide');
        $('.greet-bubble-page-'+maybe_value.toLowerCase().replace(/[^a-zA-Z0-9]+/g,'-')).removeClass('greet-bubble-metabox-hide').addClass('greet-bubble-metabox-show');
  ...
  $.fn.greet_bubble_post_formats = function() {
    if ( this.length ) {
      ...
      $(document).on('change', '.editor-post-format select, #formatdiv input[name="post_format"]', function() {
        ...
        $('.greet-bubble-post-formats').removeClass('greet-bubble-metabox-show').addClass('greet-bubble-metabox-hide');
        $('.greet-bubble-post-format-'+maybe_value).removeClass('greet-bubble-metabox-hide').addClass('greet-bubble-metabox-show');
    ...
    return this.each( function() {
      ...
      $input.on('change keyup', function() {
        ...
        var value    = $(this).val(),
            ...
            $fields  = $section.find('> .greet-bubble-field:not(.greet-bubble-depend-on)'),
            $titles  = $fields.find('> .greet-bubble-title, .greet-bubble-search-tags');
      ...
      var $this     = $(this),
          ...
          stickyUpdate = function() {
            ...
            if ( stickyTop <= offset && winWidth > 782 ) {
              ...
              $this.css({height: $this.outerHeight()}).addClass( 'greet-bubble-sticky' );
            } else {
    ...
    return this.each( function() {
      ...
      if( $fields.length ) {
        ...
        if ( global_depends.length ) {
          $.greet_bubble_deps.enable(GREET_BUBBLE.vars.$body, global_ruleset, global_depends);
        }
    ...
    return this.each( function() {
      ...
      base.notificationOverlay = function() {
        ...
        if ( wp.customize.notifications && wp.customize.OverlayNotification ) {
          ...
          wp.customize.notifications.add( new wp.customize.OverlayNotification('greet_bubble_field_backup_notification', {
            type: 'default',
            message: '&nbsp;',
            loading: true
          }));
      ...
      $reset.on('click', function( e ) {
        ...
        if ( GREET_BUBBLE.vars.is_confirm ) {
          ...
          window.wp.ajax.post('greet-bubble-reset', {
          ...
          .fail( function( response ) {
            ...
            wp.customize.notifications.remove('greet_bubble_field_backup_notification');
          });
      ...
      $import.on('click', function( e ) {
        ...
        if ( GREET_BUBBLE.vars.is_confirm ) {
          ...
          window.wp.ajax.post( 'greet-bubble-import', {
  ...
  $.fn.greet_bubble_field_background = function() {
    return this.each( function() {
      $(this).find('.greet-bubble--background-image').greet_bubble_reload_script();
    });
  };
    ...
    return this.each( function() {
      ...
      var interval = setInterval(function () {
        if ( $this.is(':visible') ) {
          ...
          if ( data_editor.theme !== 'default' && GREET_BUBBLE.vars.code_themes.indexOf(data_editor.theme) === -1 ) {
  ...
  $.fn.greet_bubble_field_datetime = function() {
    return this.each( function() {
      ...
      var $this    = $(this),
          $inputs  = $this.find('input'),
          settings = $this.find('.greet-bubble-datetime-settings').data('settings');
  ...
  $.fn.greet_bubble_field_fieldset = function() {
    return this.each( function() {
      $(this).find('.greet-bubble-fieldset-content').greet_bubble_reload_script();
    });
  };
  ...
  $.fn.greet_bubble_field_gallery = function() {
    return this.each( function() {
      ...
      $this.on('click', '.greet-bubble-button, .greet-bubble-edit-gallery', function( e ) {
  ...
  $.fn.greet_bubble_field_group = function() {
    return this.each( function() {
      ...
      var update_title_numbers = function( $selector ) {
        $selector.find('.greet-bubble-cloneable-title-number').each( function( index ) {
          $(this).html( ( $(this).closest('.greet-bubble-cloneable-item').index()+1 ) + '.' );
        });
      };

      $wrapper.accordion({
        header: '> .greet-bubble-cloneable-item > .greet-bubble-cloneable-title',
        collapsible : true,
        active: false,
        animate: false,
        heightStyle: 'content',
        ...
        activate: function( event, ui ) {
          ...
          if ( $panel.length && !$panel.data( 'opened' ) ) {
            ...
            $.each(inputs, function( key, $input ) {
              ...
              $input.on('change keyup greet-bubble.keyup', function() {
      ...
      $wrapper.sortable({
        ...
        start: function( event, ui ) {
          ...
          ui.item.children('.greet-bubble-cloneable-content').data('retry', true);

        },
        update: function( event, ui ) {

          GREET_BUBBLE.helper.name_nested_replace( $wrapper.children('.greet-bubble-cloneable-item'), field_id );
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_helper  = $parent.children('.greet-bubble-cloneable-helper').greet_bubble_clone(true),
            $cloned_title   = $parent.children('.greet-bubble-cloneable-title').greet_bubble_clone(),
            $cloned_content = $parent.children('.greet-bubble-cloneable-content').greet_bubble_clone(),
      ...
      $wrapper.children('.greet-bubble-cloneable-item').children('.greet-bubble-cloneable-helper').on('click', '.greet-bubble-cloneable-clone', event_clone);
      $group.children('.greet-bubble-cloneable-hidden').children('.greet-bubble-cloneable-helper').on('click', '.greet-bubble-cloneable-clone', event_clone);
      ...
      $wrapper.children('.greet-bubble-cloneable-item').children('.greet-bubble-cloneable-helper').on('click', '.greet-bubble-cloneable-remove', event_remove);
      $group.children('.greet-bubble-cloneable-hidden').children('.greet-bubble-cloneable-helper').on('click', '.greet-bubble-cloneable-remove', event_remove);
    ...
    return this.each( function() {
      ...
      $this.on('click', '.greet-bubble-icon-add', function( e ) {
        ...
        if ( !GREET_BUBBLE.vars.icon_modal_loaded ) {
          ...
          window.wp.ajax.post( 'greet-bubble-get-icons', {
            ...
            var $load = $modal.find('.greet-bubble-modal-load').html( response.content );
            ...
            $load.on('click', 'i', function( e ) {
              ...
              GREET_BUBBLE.vars.$icon_target.find('.greet-bubble-icon-preview i').removeAttr('class').addClass(icon);
              GREET_BUBBLE.vars.$icon_target.find('.greet-bubble-icon-preview').removeClass('hidden');
              GREET_BUBBLE.vars.$icon_target.find('.greet-bubble-icon-remove').removeClass('hidden');
              GREET_BUBBLE.vars.$icon_target.find('input').val(icon).trigger('change');

              $modal.addClass('hidden');

            });

            $modal.on('change keyup', '.greet-bubble-icon-search', function() {
            ...
            $modal.on('click', '.greet-bubble-modal-close, .greet-bubble-modal-overlay', function() {
              $modal.addClass('hidden');
            });
  ...
  $.fn.greet_bubble_field_map = function() {
    return this.each( function() {
      ...
      if ( ! $search_input.length ) {
        $search_input = $( '[data-depend-id="'+ $this.find('.greet-bubble--address-field').data( 'address-field' ) +'"]' );
      }
      ...
      $search_input.autocomplete({
        ...
        create: function (event, ui) {
          $(this).autocomplete('widget').addClass('greet-bubble-map-ui-autocomplate');
        }
      });
  ...
  $.fn.greet_bubble_field_link = function() {
    return this.each( function() {
      ...
      $edit.on('click', function( e ) {
        ...
        $('#wp-link-target').prop('checked', ($this.find('.greet-bubble--target').val() === '_blank'));
  ...
  $.fn.greet_bubble_field_media = function() {
    return this.each( function() {
      ...
      var $this            = $(this),
          ...
          $auto_attributes = ( $this.hasClass('greet-bubble-assign-field-background') ) ? $this.closest('.greet-bubble-field-background').find('.greet-bubble--auto-attributes') : false,
          wp_media_frame;
      ...
      $upload_button.on('click', function( e ) {
        ...
        wp_media_frame.on( 'select', function() {
          ...
          $this.find('.greet-bubble--url').val( attributes.url ).trigger('change');
  ...
  $.fn.greet_bubble_field_repeater = function() {
    return this.each( function() {
      ...
      $wrapper.children('.greet-bubble-repeater-item').children('.greet-bubble-repeater-content').greet_bubble_reload_script();
      ...
      $wrapper.sortable({
        ...
        update: function( event, ui ) {
          ...
          GREET_BUBBLE.helper.name_nested_replace( $wrapper.children('.greet-bubble-repeater-item'), field_id );
          $wrapper.greet_bubble_customizer_refresh();
      ...
      $repeater.children('.greet-bubble-repeater-add').on('click', function( e ) {
        ...
        $wrapper.append($cloned_item);
        $cloned_item.children('.greet-bubble-repeater-content').greet_bubble_reload_script();
        $wrapper.greet_bubble_customizer_refresh();
        $wrapper.greet_bubble_customizer_listen({closest: true});
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_content = $parent.children('.greet-bubble-repeater-content').greet_bubble_clone(),
            $cloned_helper  = $parent.children('.greet-bubble-repeater-helper').greet_bubble_clone(true),
      ...
      $wrapper.children('.greet-bubble-repeater-item').children('.greet-bubble-repeater-helper').on('click', '.greet-bubble-repeater-clone', event_clone);
      $repeater.children('.greet-bubble-repeater-hidden').children('.greet-bubble-repeater-helper').on('click', '.greet-bubble-repeater-clone', event_clone);
      ...
      $wrapper.children('.greet-bubble-repeater-item').children('.greet-bubble-repeater-helper').on('click', '.greet-bubble-repeater-remove', event_remove);
      $repeater.children('.greet-bubble-repeater-hidden').children('.greet-bubble-repeater-helper').on('click', '.greet-bubble-repeater-remove', event_remove);
  ...
  $.fn.greet_bubble_field_sortable = function() {
    return this.each( function() {
      ...
      $sortable.find('.greet-bubble-sortable-content').greet_bubble_reload_script();
  ...
  $.fn.greet_bubble_field_spinner = function() {
    return this.each( function() {
      ...
      $input.spinner({
        ...
        create: function( event, ui ) {
          if ( data.unit ) {
            $input.after('<span class="ui-button greet-bubble--unit">'+ data.unit +'</span>');
          }
        },
    ...
    return this.each( function() {
      ...
      $links.on( 'click', function( e ) {
       ...
       e.preventDefault();
        ...
        $link.addClass('greet-bubble-tabbed-active').siblings().removeClass('greet-bubble-tabbed-active');
        $content.greet_bubble_reload_script();
  ...
  $.fn.greet_bubble_field_typography = function() {
    return this.each(function () {
      ...
      base.append_select_options = function( $select, options, condition, type, is_multi ) {
        ...
        $select.append(opts).trigger('greet-bubble.change').trigger('chosen:updated');
      ...
      base.init = function () {
        ...
        if ( $font_style_block.length ) {
          ...
          var $font_style_select = $this.find('.greet-bubble--font-style-select');
          ...
          var $extra_font_style_block = $this.find('.greet-bubble--block-extra-styles');

          if ( $extra_font_style_block.length ) {
            var $extra_font_style_select = $this.find('.greet-bubble--extra-styles');
        ...
        //
        // Backup font family
        var $backup_font_family_block = $this.find('.greet-bubble--block-backup-font-family');

        //
        //
        // Font Family on Change Listener
        $font_family_select.on('change greet-bubble.change', function( event ) {
        ...
        if ( $preview_block.length ) {
          ...
          $this.on('change', GREET_BUBBLE.helper.debounce( function( event ) {
            ...
            var font_family       = $font_family_select.val(),
                ...
                text_transform    = $this.find('.greet-bubble--text-transform').val(),
                text_decoration   = $this.find('.greet-bubble--text-decoration').val(),
                text_color        = $this.find('.greet-bubble--color').val(),
                word_spacing      = $this.find('.greet-bubble--word-spacing').val(),
                letter_spacing    = $this.find('.greet-bubble--letter-spacing').val(),
  ...
  $.fn.greet_bubble_field_wp_editor = function() {
    return this.each( function() {
      ...
      if ( typeof window.wp.editor === 'undefined' || typeof window.tinyMCEPreInit === 'undefined' || typeof window.tinyMCEPreInit.mceInit.greet_bubble_wp_editor === 'undefined' ) {
        return;
      }
      ...
      // Add Media buttons
      if ( field_editor_settings.media_buttons && window.greet_bubble_media_buttons ) {

        var $editor_buttons = $editor.find('.wp-media-buttons');

        if ( $editor_buttons.length ) {

          $editor_buttons.find('.greet-bubble-shortcode-button').data('editor-id', uid);

        } else {

          var $media_buttons = $(window.greet_bubble_media_buttons);

          $media_buttons.find('.greet-bubble-shortcode-button').data('editor-id', uid);
  ...
  $.fn.greet_bubble_confirm = function() {
    return this.each( function() {
      $(this).on('click', function( e ) {
        ...
        var confirm_text   = $(this).data('confirm') || window.greet_bubble_vars.i18n.confirm;
      ...
      $this.on('click', function( e ) {
        ...
        if ( !flooding ) {
          ...
          if ( $this.hasClass('greet-bubble-save-ajax') ) {
            ...
            window.wp.ajax.post( 'greet_bubble_'+ $panel.data('unique') +'_ajax_save', {
            ...
            .done( function( response ) {
              ...
              if ( Object.keys( response.errors ).length ) {
                ...
                var error_icon = '<i class="greet-bubble-label-error greet-bubble-error">!</i>';

                $.each(response.errors, function( key, error_message ) {

                  var $field = $('[data-depend-id="'+ key +'"]'),
                      $link  = $('a[href="#tab='+ $field.closest('.greet-bubble-section').data('section-id') +'"]' ),
                      $tab   = $link.closest('.greet-bubble-tab-item');

                  $field.closest('.greet-bubble-fieldset').append( '<p class="greet-bubble-error greet-bubble-error-text">'+ error_message +'</p>' );

                  if ( !$link.find('.greet-bubble-error').length ) {
                    $link.append( error_icon );
                  }

                  if ( !$tab.find('.greet-bubble-arrow .greet-bubble-error').length ) {
  ...
  $.fn.greet_bubble_shortcode = function() {
    ...
    return this.each( function() {
      ...
      $(document).on('click', '.greet-bubble-shortcode-button[data-modal-id="'+ modal_id +'"]', function( e ) {
        ...
        if ( $modal.hasClass('greet-bubble-shortcode-single') && sc_name === undefined ) {
      ...
      $select.on( 'change', function() {
        ...
        if ( sc_key ) {
          ...
          window.wp.ajax.post( 'greet-bubble-get-shortcode-'+ modal_id, {
          ...
          .done( function( response ) {
            ...
            $cloned = $appended.find('.greet-bubble--repeat-shortcode').greet_bubble_clone();

            $appended.greet_bubble_reload_script();
            $appended.find('.greet-bubble-fields').greet_bubble_reload_script();
      ...
      $insert.on('click', function( e ) {
        ...
        var shortcode = '';
        var serialize = $modal.find('.greet-bubble-field:not(.greet-bubble-depend-on)').find(':input:not(.ignore)').serializeObjectGREET_BUBBLE();
        ...
        if ( gutenberg_id ) {
          ...
          var content = window.greet_bubble_gutenberg_props.attributes.hasOwnProperty('shortcode') ? window.greet_bubble_gutenberg_props.attributes.shortcode : '';
          window.greet_bubble_gutenberg_props.setAttributes({shortcode: content + shortcode});
      ...
      $modal.on('click', '.greet-bubble--repeat-button', function( e ) {
        ...
        GREET_BUBBLE.helper.name_nested_replace( $modal.find('.greet-bubble--repeat-shortcode'), sc_group );
  ...
  $.fn.greet_bubble_color = function() {
    return this.each( function() {
      ...
      var $input        = $(this),
          ...
          palette_color = window.greet_bubble_vars.color_palette.length ? window.greet_bubble_vars.color_palette : true,
          $container;
      ...
      $input.wpColorPicker({
        ...
        change: function( event, ui ) {
          ...
          $container.find('.greet-bubble--transparent-offset').css('background-color', ui_color_value);
        ...
        create: function() {
          ...
          var a8cIris = $input.data('a8cIris'),
              $transparent_wrap = $('<div class="greet-bubble--transparent-wrap">' +
              ...
              $transparent_offset = $transparent_wrap.find('.greet-bubble--transparent-offset'),
              $transparent_button = $transparent_wrap.find('.greet-bubble--transparent-button');
          ...
          $transparent_slider.slider({
            ...
            create: function() {
              ...
              $container.on('click', '.wp-picker-default', function() {
                ...
                var default_color = GREET_BUBBLE.funcs.parse_color( $input.data('default-color') ),
  ...
  $.fn.greet_bubble_checkbox_all = function() {
    return this.each( function() {
      ...
      $this.on('click', function() {
        ...
        var $inputs = $this.closest('.greet-bubble-field-checkbox').find(':input'),
            uncheck = false;
    ...
    return this.each( function() {
      ...
      $siblings.on('click', function() {
        ...
        if ( multiple ) {
          ...
          $sibling.find('input').prop('checked', true).trigger('change');
          $sibling.addClass('greet-bubble--active').siblings().removeClass('greet-bubble--active');
    ...
    return this.each( function() {
      ...
      $this.on({
        mouseenter: function() {
          ...
          $tooltip = $( '<div class="greet-bubble-tooltip"></div>' ).html( $this.find('.greet-bubble-help-text').html() ).appendTo('body');
          offset_left = ( GREET_BUBBLE.vars.is_rtl ) ? ( $this.offset().left + 24 ) : ( $this.offset().left - $tooltip.outerWidth() );
  ...
  $.fn.greet_bubble_customizer_listen = function( options ) {
    ...
    return this.each( function() {
      ...
      var $this     = ( settings.closest ) ? $(this).closest('.greet-bubble-customize-complex') : $(this),
          $input    = $this.find(':input'),
  ...
  // Window on resize
  //
  GREET_BUBBLE.vars.$window.on('resize greet-bubble.resize', GREET_BUBBLE.helper.debounce( function( event ) {

    var window_width = navigator.userAgent.indexOf('AppleWebKit/') > -1 ? GREET_BUBBLE.vars.$window.width() : window.innerWidth;
  ...
  }, 200)).trigger('greet-bubble.resize');
  ...
  $.fn.greet_bubble_nav_menu = function() {
    return this.each( function() {
      ...
      $navmenu.on('click', 'a.item-edit', function() {
        $(this).closest('li.menu-item').find('.greet-bubble-fields').greet_bubble_reload_script();
      });
  ...
  $.fn.greet_bubble_reload_script_retry = function() {
    return this.each( function() {
      ...
      if ( $this.data('inited') ) {
        $this.children('.greet-bubble-field-wp_editor').greet_bubble_field_wp_editor();
      }
  ...
  $.fn.greet_bubble_reload_script = function( options ) {
    ...
    return this.each( function() {
      ...
      if ( !$this.data('inited') ) {
        ...
        // Field plugins
        $this.children('.greet-bubble-field-accordion').greet_bubble_field_accordion();
        $this.children('.greet-bubble-field-backup').greet_bubble_field_backup();
        $this.children('.greet-bubble-field-background').greet_bubble_field_background();
        $this.children('.greet-bubble-field-code_editor').greet_bubble_field_code_editor();
        $this.children('.greet-bubble-field-date').greet_bubble_field_date();
        $this.children('.greet-bubble-field-datetime').greet_bubble_field_datetime();
        $this.children('.greet-bubble-field-fieldset').greet_bubble_field_fieldset();
        $this.children('.greet-bubble-field-gallery').greet_bubble_field_gallery();
        ...
        $this.children('.greet-bubble-field-repeater').greet_bubble_field_repeater();
        $this.children('.greet-bubble-field-slider').greet_bubble_field_slider();
        $this.children('.greet-bubble-field-sortable').greet_bubble_field_sortable();
        ...
        // Field colors
        $this.children('.greet-bubble-field-border').find('.greet-bubble-color').greet_bubble_color();
        $this.children('.greet-bubble-field-background').find('.greet-bubble-color').greet_bubble_color();
        $this.children('.greet-bubble-field-color').find('.greet-bubble-color').greet_bubble_color();
        $this.children('.greet-bubble-field-color_group').find('.greet-bubble-color').greet_bubble_color();
        $this.children('.greet-bubble-field-link_color').find('.greet-bubble-color').greet_bubble_color();
        $this.children('.greet-bubble-field-typography').find('.greet-bubble-color').greet_bubble_color();

        // Field chosenjs
        $this.children('.greet-bubble-field-select').find('.greet-bubble-chosen').greet_bubble_chosen();

        // Field Checkbox
        $this.children('.greet-bubble-field-checkbox').find('.greet-bubble-checkbox').greet_bubble_checkbox();
        $this.children('.greet-bubble-field-checkbox').find('.greet-bubble-checkbox-all').greet_bubble_checkbox_all();

        // Field Siblings
        $this.children('.greet-bubble-field-button_set').find('.greet-bubble-siblings').greet_bubble_siblings();
        $this.children('.greet-bubble-field-image_select').find('.greet-bubble-siblings').greet_bubble_siblings();
        $this.children('.greet-bubble-field-palette').find('.greet-bubble-siblings').greet_bubble_siblings();

        // Help Tooptip
        $this.children('.greet-bubble-field').find('.greet-bubble-help').greet_bubble_help();
