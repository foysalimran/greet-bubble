 ...
 *
 */
if ( ! class_exists( 'GREET_BUBBLE_Field_link_color' ) ) {
  class GREET_BUBBLE_Field_link_color extends GREET_BUBBLE_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'greet-bubble' ),
        'hover'    => esc_html__( 'Hover', 'greet-bubble' ),
        'active'   => esc_html__( 'Active', 'greet-bubble' ),
        'visited'  => esc_html__( 'Visited', 'greet-bubble' ),
        'focus'    => esc_html__( 'Focus', 'greet-bubble' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="greet-bubble--left greet-bubble-field-color">';
          echo '<div class="greet-bubble--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="greet-bubble-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
