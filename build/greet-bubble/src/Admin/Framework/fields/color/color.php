 ...
 *
 */
if ( ! class_exists( 'GREET_BUBBLE_Field_color' ) ) {
  class GREET_BUBBLE_Field_color extends GREET_BUBBLE_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="greet-bubble-color"'. $default_attr . $this->field_attributes() .'/>';
