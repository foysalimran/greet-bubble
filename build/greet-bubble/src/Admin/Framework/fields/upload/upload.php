 ...
 *
 */
if ( ! class_exists( 'GREET_BUBBLE_Field_upload' ) ) {
  class GREET_BUBBLE_Field_upload extends GREET_BUBBLE_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="greet-bubble--preview'. esc_attr( $preview_hidden ) .'">';
      ...
      echo '<a href="#" class="button button-primary greet-bubble--button" data-library="'. esc_attr( $library ) .'">'. $args['button_title'] .'</a>';
      echo '<a href="#" class="button button-secondary greet-bubble-warning-primary greet-bubble--remove'. esc_attr( $hidden ) .'">'. $args['remove_title'] .'</a>';
      echo '</div>';
