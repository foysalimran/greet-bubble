 ...
 *
 */
if ( ! class_exists( 'GREET_Field_palette' ) ) {
  class GREET_Field_palette extends GREET_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $palette ) ) {
        ...
        echo '<div class="greet-siblings greet--palettes">';

        foreach ( $palette as $key => $colors ) {

          $active  = ( $key === $this->value ) ? ' greet--active' : '';
          $checked = ( $key === $this->value ) ? ' checked' : '';

          echo '<div class="greet--sibling greet--palette'. esc_attr( $active ) .'">';
