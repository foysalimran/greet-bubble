 ...
 *
 */
if ( ! class_exists( 'GREET_Field_sortable' ) ) {
  class GREET_Field_sortable extends GREET_Fields {
    ...
    public function render() {
      ...
      echo '<div class="greet-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="greet-sortable-item">';

          echo '<div class="greet-sortable-content">';
          ...
          GREET::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="greet-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
