 ...
 *
 */
if ( ! class_exists( 'GREET_Field_sorter' ) ) {
  class GREET_Field_sorter extends GREET_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'greet' ),
        'disabled_title' => esc_html__( 'Disabled', 'greet' ),
      ) );
      ...
      echo '<div class="greet-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="greet-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="greet-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="greet-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="greet-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="greet-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="greet-disabled">';
