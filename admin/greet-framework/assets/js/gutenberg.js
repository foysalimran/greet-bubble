...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.greet_gutenberg_blocks ) { return; }

  Object.values(window.greet_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'greet-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary greet-shortcode-button',
              onClick: function () {
                window.greet_gutenberg_props = props;
              },
            }, block.button_title ),
