...
(function($) {
  ...
  function GREETAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  GREETAjaxChosen.prototype.init = function() {
  ...
  GREETAjaxChosen.prototype.events = function() {
  ...
  GREETAjaxChosen.prototype.search_field_focused = function() {
  ...
  GREETAjaxChosen.prototype.search_welcome_message = function() {
  ...
  GREETAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('greet-chosen', _this.options.data).done( function( response ) {
  ...
  GREETAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.greet-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.GREETChosenOrder($hidden_value, true);
  ...
  $.fn.GREETAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new GREETAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, GREETAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  GREETAbstractChosenOrder = (function() {

    function GREETAbstractChosenOrder() {}

    GREETAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    GREETAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    GREETAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    GREETAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    GREETAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    GREETAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    GREETAbstractChosenOrder.GREETChosenOrder = function(select, order, force) {
    ...
    return GREETAbstractChosenOrder;
  ...
  $.fn.extend({
    GREETChosenOrder: function(order, force) {
      return _GREETChosenOrder.GREETChosenOrder(this, order, force);
    }
  });

  this._GREETChosenOrder = (function(_super) {
    __extends(_GREETChosenOrder, _super);

    function _GREETChosenOrder() {
      _ref = _GREETChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _GREETChosenOrder.relAttributeName = 'data-option-array-index';

    _GREETChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _GREETChosenOrder.getDOMElement = function(element) {
    ...
    _GREETChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _GREETChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _GREETChosenOrder;

  })(GREETAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('greet-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectGREET = FormSerializer.serializeObject;
    $.fn.serializeJSONGREET   = FormSerializer.serializeJSON;
  }
