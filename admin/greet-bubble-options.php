...
// Create a section
//
GREET::createSection($prefix, array(
...
// Templates options
GREET::createSection($prefix, array(
    'title'  => esc_html__('GET HELP', 'greet-bubble'),
    'icon'   => 'fas fa-life-ring',
    'fields' => array(

        array(
            'id'    => 'greet-formtitletest',
            'type'  => 'text',
            'type'     => 'callback',
            'function' => 'greet_get_help_callback',
        ),
...
?>
    <div class="wrap">
        <div class="greet-help-wrapper">
            <div class="greet__help--header">
                <h3>Greet Bubble <span><?php echo GREET_VERSION; ?></span></h3>
                Thank you for installing <strong>Greet Bubble</strong> plugin! This video will help you get started with the plugin.
            </div>

            <div class="greet__help--video">
            ...
            <div class="greet__help--footer">
                <a class="button button-primary" href="<?php echo get_admin_url() . '/admin.php?page=greet-options'; ?>">Go to settings page</a>
